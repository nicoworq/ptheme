    ...
    class Storefront {
        ...
        public function widgets_init() {
            ...
            register_sidebar(array(
                ...
                'description' => 'Los widgets añadidos a este sidebar, seran mostrados en el listado de productos con subcategorías',
                'before_widget' => '<aside id="%1$s" class="widget %2$s">',
                'after_widget' => '</aside>',
                'before_title' => '<h3 class="widget-title">',
                'after_title' => '</h3>',
        ...
        public function scripts() {
            ...
            $google_fonts = apply_filters('storefront_google_font_families', array(
                'source-sans-pro' => 'Source+Sans+Pro:300,300italic,400,600,700',
            ));
