...
if (!class_exists('Storefront_WooCommerce')) :
    ...
    class Storefront_WooCommerce {
        ...
        public function woocommerce_scripts() {
            ...
            wp_enqueue_style('worq-style', get_template_directory_uri() . '/assets/css/main.min.css?a=beaaa');
            ...
            wp_enqueue_script('pascal-plugins', get_template_directory_uri() . '/assets/js/plugins.js', array('jquery'), '20151215', true);
            wp_enqueue_script('pascal-scripts', get_template_directory_uri() . '/assets/js/main.min.js?casd=eee', array('jquery'), '20151215', true);
            
           
            

            wp_localize_script('pascal-scripts', 'Pascal', array('ajaxUrl' => admin_url('admin-ajax.php'), 'themeUrl' => get_stylesheet_directory_uri()));
        }
